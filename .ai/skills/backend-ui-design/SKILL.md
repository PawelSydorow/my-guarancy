...
description: Design and implement consistent, production-grade backend/backoffice interfaces for the standalone my-guarancy app using the @open-mercato/ui component library. Use this skill when building admin pages, CRUD interfaces, data tables, forms, detail pages, or any backoffice UI components.
---

This skill guides creation of consistent, production-grade backend/backoffice interfaces for the standalone app using the established @open-mercato/ui component library. All implementations must leverage existing components to maintain visual and behavioral consistency across modules.
